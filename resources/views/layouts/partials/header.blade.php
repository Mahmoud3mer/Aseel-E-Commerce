            ...
            <div class="col-lg-12 col-sm-12 text-center">
                <div class="main-menu-wrap">
                    ...
                    <nav class="main-menu" dir="rtl">
                        <ul>
                            <li class="{{ request()->routeIs('home') ? 'current-list-item' : '' }}"><a href="{{route('home')}}">الرئيسية</a></li>
                            ...
                            <li class="{{ request()->routeIs('customers.index') ? 'current-list-item' : '' }}"><a href="{{route('customers.index')}}"> أراء العملاء </a></li>
                            ...
                            <li>
                                <div class="header-icons">
                                    ...
                                    @auth
                                        <form action="{{ route('logout') }}" method="POST" style="display:inline;"  class="mobile-hide logout-bar-icon">
                                            @csrf
                                            <button type="submit"
                    ...
                    @auth
                        <form action="{{ route('logout') }}" method="POST" style="position: absolute; right: 90px; top: 22px; z-index: 999; font-weight: bold;" 
